...
namespace MovieStore.API.Tests
{
    public class CategoriesControllerTests
    {
        ...
        public CategoriesControllerTests()
        {
            ...
            _categoriesController = new CategoryController(_mapperMock.Object, _categoryServiceMock.Object);
        }
        ...
        public async void GetAll_ShouldReturnOk_WhenExistCategory()
        {
            ...
            _mapperMock.Setup(x => x.Map<IEnumerable<CategoryResultDto>>(It.IsAny<List<Category>>())).Returns(dtoExpected);
        ...
        public async void GetById_ShouldReturnOk_WhenCategoryExist()
        {
            ...
            _categoryServiceMock.Setup(x => x.GetById(2)).ReturnsAsync(category);
            _mapperMock.Setup(x => x.Map<CategoryResultDto>(It.IsAny<Category>())).Returns(dtoExpected);
        ...
        {
            _categoryServiceMock.Setup(x => x.GetById(2)).ReturnsAsync((Category)null);
        ...
        public async void Add_ShouldReturnOk_WhenCategoryIsAdded()
        {
            ...
            _mapperMock.Setup(x => x.Map<Category>(It.IsAny<CategoryAddDto>())).Returns(category);
            _categoryServiceMock.Setup(x => x.Add(category)).ReturnsAsync(category);
            _mapperMock.Setup(x => x.Map<CategoryResultDto>(It.IsAny<Category>())).Returns(categoryResultDto);
        ...
        public async void Add_ShouldReturnBadRequest_WhenCategoryResultIsNull()
        {
            ...
            _mapperMock.Setup(x => x.Map<Category>(It.IsAny<CategoryAddDto>())).Returns(category);
            _categoryServiceMock.Setup(x => x.Add(category)).ReturnsAsync((Category)null);
        ...
        public async void Update_ShouldReturnOk_WhenCategoryIsUpdatedCorrectly()
        {
            ...
            _mapperMock.Setup(x => x.Map<Category>(It.IsAny<CategoryEditDto>())).Returns(category);
            _categoryServiceMock.Setup(x => x.GetById(category.Id)).ReturnsAsync(category);
            _categoryServiceMock.Setup(x => x.Update(category)).ReturnsAsync(category);
        ...
        public async void Remove_ShouldReturnOk_WhenCategoryIsRemoved()
        {
            var category = CreateCategory();
            _categoryServiceMock.Setup(x => x.GetById(category.Id)).ReturnsAsync(category);
            _categoryServiceMock.Setup(x => x.Remove(category)).ReturnsAsync(true);
        ...
        {
            var category = CreateCategory();
            _categoryServiceMock.Setup(x => x.GetById(category.Id)).ReturnsAsync((Category)null);
        ...
        public async void Remove_ShouldReturnBadRequest_WhenResultIsFalse()
        {
            var category = CreateCategory();
            _categoryServiceMock.Setup(x => x.GetById(category.Id)).ReturnsAsync(category);
            _categoryServiceMock.Setup(x => x.Remove(category)).ReturnsAsync(false);
        ...
        public async void Search_ShouldReturnOk_WhenCategoryWithSearchedNameExist()
        {
            ...
            _categoryServiceMock.Setup(x => x.Search(category.Name)).ReturnsAsync(categoryList);
            _mapperMock.Setup(x => x.Map<List<Category>>(It.IsAny<IEnumerable<Category>>())).Returns(categoryList);
        ...
        public async void Search_ShouldReturnNotFound_WhenCategoryWithSearchedNameDoesNotExist()
        {
            ...
            _categoryServiceMock.Setup(x => x.Search(category.Name)).ReturnsAsync(categoryList);
            _mapperMock.Setup(x => x.Map<IEnumerable<Category>>(It.IsAny<Category>())).Returns(categoryList);
